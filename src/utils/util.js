...
// 保留7位小数
function numToFixed(v) {
  // parseFloat(v).toFixed(7); // 保留7位
  // Math.round(parseFloat(v));// 保留整数
  return parseFloat(v).toFixed(7) / 1;
}
// 四舍五入保留整数
function numToFixedInt(v) {
  // parseFloat(v).toFixed(7); // 保留7位
  // Math.round(parseFloat(v));// 保留整数
  return Math.round(parseFloat(v));
}
// 向下取整
function numToFixedFloor(v) {
  // 5.1 —— 5
